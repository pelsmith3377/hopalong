...
'''
This routine sends starting parameters to the main hopalong routine.
'''
...
def hopalong(screen, function="Pelican"):
    testing = config.testing
    verbose = config.verbose
    # OG hop types = ("Martin1", "Martin2", "Ejk1", "Ejk2", "Ejk3", "Ejk4", "Ejk5", "Ejk6")
    # Weight toward choosing favorites.  Note these are my favorites, alter the lists as you see fit.
    ...
    screen.clear()
    for _ in range(start_over_counter):
        for _ in range(color_change):  # change color once falls out
